...
setup(name='%s_%s' % (PREFIX, MODULE),
    ...
    url='https://github.com/NaN-tic/trytond-agronomics_product_bulk',
    download_url='https://github.com:nantic/trytond-agronomics_product_bulk.git',
    ...
    project_urls = {
       "Source Code": 'https://github.com:NaN-tic/trytond-agronomics_product_bulk.git'
    },
    classifiers=[
